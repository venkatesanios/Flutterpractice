...
import 'package:flutter_practice_sample/ui/views/group_unit/group_unit_view.dart'
    as _i2;
import 'package:flutter_practice_sample/ui/views/login/login_view.dart' as _i3;
import 'package:stacked/stacked.dart' as _i1;
import 'package:stacked_services/stacked_services.dart' as _i5;

class Routes {
  static const groupUnitView = '/';
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    _i2.GroupUnitView: (data) {
      return _i4.MaterialPageRoute<dynamic>(
        builder: (context) => const _i2.GroupUnitView(),
        settings: data,
      );
    },
    _i3.LoginView: (data) {
